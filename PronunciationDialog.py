...
class PronunciationDialog(wx.Dialog):
    def __init__(self, parent, phoneme_set):
        ...
        ##self.wordLabel = wx.StaticText(self, -1, _("Break down the word:"), style=wx.ALIGN_CENTRE)  ## DEPRICIATED wxGlade.gettext._()
        ...
        ##self.button_1 = wx.Button(self, wx.ID_OK, _("OK"))  ## DEPRICIATED wxGlade.gettext._()
        ##self.button_2 = wx.Button(self, wx.ID_CANCEL, _("Cancel"))  ## DEPRICIATEDwxGlade.gettext._()
    ...
    def __set_properties(self):
        ...
        ##self.SetTitle(_("Unknown Word"))  ## DEPRECIATED wxGlade.gettext._()
