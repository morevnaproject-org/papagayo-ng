...
strip_symbols += u'\N{LEFT SINGLE QUOTATION MARK}'
strip_symbols += u'\N{RIGHT SINGLE QUOTATION MARK}'
strip_symbols += u'\N{LEFT DOUBLE QUOTATION MARK}'
strip_symbols += u'\N{RIGHT DOUBLE QUOTATION MARK}'
